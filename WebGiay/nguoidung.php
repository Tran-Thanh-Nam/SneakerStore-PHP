...
<?php
    session_start();
    include_once("./models/nguoidungclass.php");
?>
...
<html>
    <head>
        ...
        <link href="fontawesome/js/all.min.css" type="text/js" rel="stylesheet">
        ...
        <div id="wrapper">
                ...
                <div class="row">
                    <div id="dLeft" class="col-md-4 col-sm-4 col-lg-2 col-xs-0">
                         <?php include_once("Views/v_left_nguoidung.php"); ?> 
                    </div>
                    <div id="dRight" class="col-md-8 col-sm-8 col-lg-10 col-xs-12">
                        <?php
                            include_once("Views/v_nguoidung.php");
